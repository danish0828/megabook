      ...
      <div class="container pt-12 pt-md-14 pb-14 pb-md-16">
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
            <h1 class="mb-3">Oops! Page Not Found Babar.</h1>
            <p class="lead mb-7 px-md-12 px-lg-5 px-xl-7">The page you're looking for is not available or has been moved. Try a different page or go to homepage with the button below.</p>
