...
<head>
    ...
    <title>Megabook Writing | Editing Publishing</title>
            ...
            <div class="container pb-15 pb-md-17">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center">
                        ...
                        <h3 class="display-3 mb-10 px-xl-10 px-xxl-15">Here are a few <span class="underline-3 style-2 yellow">reasons</span> why our customers choose Megabook.</h3>
                    </div>
                    <!-- /column -->
                </div>
                <!-- /.row -->
            ...
            <div class="container py-14 pt-md-18 pb-md-16">
                <div class="row align-items-center mb-10">
                    <div class="col-md-8 col-lg-9 col-xl-8 col-xxl-7 pe-xl-20">
                        ...
                        <p class="lead fs-20 mb-0">Check out some of my latest Services with creative ideas.</p>
                    </div>
                    <!--/column -->
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-soft-leaf mb-10">
                            <div class="card-body p-12 pb-0">
                                ...
                                <h3 class="h1 post-title mb-3">Story Writing</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-soft-pink">
                            <div class="card-body p-12 pb-0">
                                ...
                                <h3 class="h1 post-title mb-3">Memoir Writing</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-soft-leaf mb-10">
                            <div class="card-body p-12 pb-0">
                                ...
                                <h3 class="h1 post-title mb-3">Fiction Writing</h3>
                                <p>Maecenas faucibus mollis interdum sed posuere porta consectetur cursus porta lobortis. Scelerisque id ligula felis.</p>
                                <a href="#" class="more hover link-leaf mb-8">View Service</a>
                            </div>
                            <!--/.card-body -->
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-soft-pink">
                            <div class="card-body p-12 pb-0">
                                ...
                                <h3 class="h1 post-title mb-3">Non-Fiction Writing</h3>
                                <p>Maecenas faucibus mollis interdum sed posuere consectetur est at lobortis. Scelerisque id ligula porta felis euismod semper.</p>
                                <a href="#" class="more hover link-pink mb-8">View Service</a>
                            </div>
                            <!--/.card-body -->
