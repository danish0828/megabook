...
<head>
  ...
  <meta name="description" content="We have created a home here for writers who are aware of writing skillfully in accordance with the genre. Our platform has accumulated writers after extensive vetting, all with expertise in a specific domain.
">
  <meta name="keywords" content="">
  <meta name="author" content="elemis">
  <title>Journey of Transforming Ideas into a Vision | About Mega
</title>
      ...
      <div class="container pt-10 pt-md-14 text-center">
        <div class="row">
          <div class="col-xl-6 mx-auto">
            <h1 class="display-1 mb-4">Writing Never Seemed Simpler
            </h1>
            <p class="lead fs-lg mb-0">Welcome aboard, writers, on this journey of transforming raw ideas into a vision.
            </p>
          </div>
          <!-- /column -->
        </div>
      ...
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <h2 class="display-4 mb-3">Crafting Results Of Exceptional Value
            </h2>
            <p class="lead fs-lg">We have immense pride in ourselves for providing a platform that gives the final push to writers who come back as accomplished authors.
            </p>
            <p class="mb-6">We have reached this highest level of excellence with years of experience and a pool of competent and skillful writers who do not compromise the quality of work and consistently deliver a final product that speaks to the masses profoundly.
            </p>
            <div class="row gy-3 gx-xl-8">
              <div class="col-xl-6">
                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                  <li><span><i class="uil uil-check"></i></span><span>We provide absolutely original content with a unique angle of personal touch.
                    </span></li>
                  <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Our writers are professionally trained individuals with expertise in all forms of writing.
                    </span></li>
                </ul>
              </div>
              <!--/column -->
              <div class="col-xl-6">
                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                  <li><span><i class="uil uil-check"></i></span><span>We have created a home here for writers who are aware of writing skillfully in accordance with the genre.
                    </span></li>
                  <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Our platform has accumulated writers after extensive vetting, all of which have expertise in a specific domain.
                    </span></li>
                </ul>
              </div>
              <!--/column -->
        ...
        <div class="row mb-5">
          <div class="col-md-10 col-xl-8 col-xxl-7 mx-auto text-center">
            ...
            <h2 class="display-4 mb-4 px-lg-14">We adhere to an absolutely transparent process to bring your visions alive.
            </h2>
          </div>
          <!-- /column -->
        </div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <div class="card me-lg-6">
              <div class="card-body p-6">
                <div class="d-flex flex-row">
                  ...
                  <div>
                    <h4 class="mb-1">Join Our Family
                    </h4>
                    <p class="mb-0">Sign up with us now and get in touch with professional writers.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="card ms-lg-13 mt-6">
              <div class="card-body p-6">
                <div class="d-flex flex-row">
                  ...
                  <div>
                    <h4 class="mb-1">Exchange Insights
                    </h4>
                    <p class="mb-0">We extract your ideas, offer better solutions and present them to convey your message effectively.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="card mx-lg-6 mt-6">
              <div class="card-body p-6">
                <div class="d-flex flex-row">
                  ...
                  <div>
                    <h4 class="mb-1">Own A Masterpiece
                    </h4>
                    <p class="mb-0">Transition from being a writer to an author by owning a bestseller under your very name.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <!--/column -->
          <div class="col-lg-6">
            <h2 class="display-6 mb-3">Speak Your Truth To The World
            </h2>
            <p class="lead fs-lg pe-lg-5">We believe in the power of two and hence, provides you with a collaborative platform that will utilize your ideas and our writing skills to create the next great masterpiece.
            </p>
            <p class="mb-6">To transform your writing dreams into a concrete reality, we go through a comprehensive procedure that starts by conducting interviews with our clients to extract as much of their ideas as possible, and using those insights; further research is performed that enables our writers to feel equipped enough to now officially write. Writing is just the start; we also edit, format, market, design, and promote your book for maximum reach.
            </p>
            <p class="mb-6">At the same time, we follow stringent rules regarding your book, ideas, and intellectual belonging's privacy and security and deliver you unique and original content with complete freedom of speech so as to give your very own personal touch.
      ...
      <div class="container py-14 py-md-16">
        <div class="row mb-3">
          <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
            ...
            <h2 class="display-4 mb-3 px-lg-14">Meet our family, without which our dream would be just that: a dream.
</h2>
          </div>
          <!--/column -->
        </div>
      ...
      <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <h2 class="display-4 mb-8">Contact us anytime you have a budding idea; we'll bring potential to it!</h2>
            <div class="d-flex flex-row">
              <div>
